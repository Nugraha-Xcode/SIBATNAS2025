...
import Service from "src/services/data_raster.service";
...
export const retrieve = () => async (dispatch) => {
  try {
    ...
    dispatch({
      type: RETRIEVE_DATA_RASTER_SUCCESS,
      payload: res.data,
    });
  } catch (err) {
...
export const create = (data) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: CREATE_DATA_RASTER_SUCCESS,
      payload: res.data,
    });
...
export const update = (uuid, data) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: UPDATE_DATA_RASTER_SUCCESS,
      payload: data,
    });
...
export const remove = (uuid) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: DELETE_DATA_RASTER_SUCCESS,
      payload: { uuid },
    });
  } catch (err) {
    if (err.response && err.response.status === 401) {
