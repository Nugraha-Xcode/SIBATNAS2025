...
function KategoriTab() {
  ...
  const initialConfig = {
    ...
    mode: "add",
    action: "Submit",
    description: "Silahkan isi form berikut untuk menambahkan Kategori baru.",
  };
  const [config, setConfig] = useState(initialConfig);
  const datas = useSelector((state) => state.kategoriEksternal);
                  ...
                  {datas &&
                    datas.map((data) => (
                      <TableRow key={data.uuid} hover>
                        ...
                        <TableCell>{data.cakupanWilayah?.name}</TableCell>
