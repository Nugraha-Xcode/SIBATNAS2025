...
function ManagementsData_raster() {
  const [currentTab, setCurrentTab] = useState("daftar");

  const tabs = [{ value: "daftar", label: "Daftar Data_raster" }];
  ...
  return (
    <>
      <Helmet>
        <title>Managements - Data_raster</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader />
      </PageTitleWrapper>
...
export default ManagementsData_raster;
