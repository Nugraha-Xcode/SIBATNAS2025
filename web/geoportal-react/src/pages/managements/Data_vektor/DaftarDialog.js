...
import { create, remove, update } from "src/redux/actions/data_vektor";
...
function Data_vektorDialog(props) {
  ...
  function isValidated() {
    //console.log(user);
    return data.nama_data_vektor.length > 0;
  }
    ...
    >
      ...
      <DialogContent>
        ...
        <TextField
          ...
          fullWidth
          id="nama_data_vektor"
          label="Nama Data_vektor"
          name="nama_data_vektor"
          value={data.nama_data_vektor}
          onChange={handleInputChange}
          autoComplete="nama_data_vektor"
          autoFocus
...
Data_vektorDialog.propTypes = {
  onClose: PropTypes.func.isRequired,
  open: PropTypes.bool.isRequired,
  config: PropTypes.object.isRequired,
};

export default Data_vektorDialog;
