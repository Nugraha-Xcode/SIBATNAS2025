import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, 
    FormControl, IconButton, ImageList, ImageListItem, ImageListItemBar, InputLabel, ListSubheader, MenuItem, Paper, Select, Tab, Tabs, TextField, Typography } from "@mui/material";
        ...
        >
            <DialogTitle style={{ cursor: 'move', padding: '5px 10px', backgroundColor: '#f3f3f3' }} id="draggable-dialog-title">
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <h5 style={{ margin: '0px' }}>Peta Dasar</h5>
                ...
                <ImageList  cols={2} rowHeight={115}>
                    ...
                    {itemData.map((item) => (
                        <ImageListItem key={item.id}>
                            ...
                            <ImageListItemBar
                                title={item.title}
                                subtitle={<span>oleh: {item.author}</span>}
                                classes={{
