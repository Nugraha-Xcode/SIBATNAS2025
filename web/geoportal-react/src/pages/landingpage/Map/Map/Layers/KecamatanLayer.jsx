...
const StatisticLayer = ({ zIndex = 0, visible = true, kode=53, layer = "pus_hamil", loadKabupaten }) => {
    ...
    */
    function resiko(feature) {
        ...
        return createStyleRange(feature, 'P_RISK', 27.07, 39, 59.27, 'WADMKC')
    }
    ...
    function create_content(feature, layer) {
        if (layer == 'pus_hamil')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah PUS Hamil: <b>" + parseInt(feature.get('PUSHMLN')).toLocaleString('id-ID') + "</b><br/>Persentase PUS Hamil: <b>" + parseFloat(feature.get('PUSHMLN')).toFixed(2).replace(".", ",") + "%</b>";
        else if (layer == 'pra_sejahtera')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Pra Sejahtera: <b>" + parseInt(feature.get('PRASEJ')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga Pra Sejahtera: <b>" +  parseFloat(feature.get('PRASEJN')).toFixed(2).replace(".", ",") + "%</b>";
        else if (layer == 'air_minum')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran Memiliki Sumber Air Minum Tidak Layak: <b>" + parseInt(feature.get('SMBAIRB')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga Sasaran Memiliki Sumber Air Minum Tidak Layak: <b>" +  parseFloat(feature.get('SMBAIRBN')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'rumah')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran Memiliki Rumah Tidak Layak Huni: <b>" + parseInt(feature.get('RMHLYKB')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga Sasaran Memiliki Rumah Tidak Layak Huni: <b>" +  parseFloat(feature.get('RMHLYKBN')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'jamban')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran Memiliki Jamban Tidak Layak: <b>" + parseInt(feature.get('JMBNLYKB')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga Sasaran Memiliki Jamban Tidak Layak: <b>" +  parseFloat(feature.get('JMBNLYKBN')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'stunting')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Prevalensi Stunting: <b>" +  parseFloat(feature.get('PREV_STUNT')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'underweight')
            return"<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Prevalensi Underweight: <b>" +  parseFloat(feature.get('PREV_UDRWG')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'resiko')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Beresiko Stunting: <b>" + parseInt(feature.get('RISK')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga Beresiko Stunting: <b>" +  parseFloat(feature.get('RISKN')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'anak_0_23')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga dengan Anak Usia 0-23 Bulan: <b>" + parseInt(feature.get('BLN_0_23')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga dengan Anak Usia 0-23 Bulan: <b>" +  parseFloat(feature.get('BLN_0_23N')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'anak_24_59')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga dengan Anak Usia 24-59 Bulan: <b>" + parseInt(feature.get('BLN_24_59')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga dengan Anak Usia 24-59 Bulan: <b>" +  parseFloat(feature.get('BLN_24_59N')).toFixed(2).replace(".", ",")  + "%</b>";
        else if (layer == 'balita')
            return "<span style='font-weight:bolder;color: #2F4E6F'>" + feature.get('WADMKC') + "</span><br />Jumlah Keluarga: <b>" + parseInt(feature.get('JML_KLG')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga Sasaran: <b>" + parseInt(feature.get('KLG_SSRN')).toLocaleString('id-ID') + "</b><br />Jumlah Keluarga dengan Anak Usia Balita: <b>" + parseInt(feature.get('BALITAB')).toLocaleString('id-ID') + "</b><br/>Persentase Keluarga dengan Anak Usia Balita: <b>" +  parseFloat(feature.get('BALITAN')).toFixed(2).replace(".", ",")  + "%</b>";
    }
    ...
    useEffect(() => {
        ...
        const vectorLayer = new VectorLayer({
            ...
            source: new VectorSource({
                //url: './data/kecamatan/'+kode+'.geojson',
                url: './2023/kecamatan_banyuasin.geojson',
                format: new GeoJSON(),
            }),
        ...
        vectorLayer.set('id', 'kecamatan_layer')
