...
const getAllProvince = (uuid) => {
  //return http.get("/tutorials");
  return http.get(`/${base}/province/${uuid}`, { headers: authHeader() });
};

const getAllProvinceUser = (uuid) => {
  //return http.get("/tutorials");
  return http.get(`/${base}/province-user/${uuid}`, { headers: authHeader() });
};
const get = (uuid) => {
