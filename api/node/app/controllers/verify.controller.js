...
const uploadVerifikasi = require("../middleware/uploadVerifikasi");
const fs = require("fs");

exports.check = async (req, res) => {
  try {
    //console.log(objectValue);
    await uploadVerifikasi(req, res);
    ...
    const url = config.api_grass + "/verifikasi/" + req.file.filename; // Replace with your API endpoint URL
    console.log(url);
