...
const controller = require("../controllers/dataPerbaikanProdusen.controller.js");
const base = "/api/data-perbaikan-produsen/";
...
module.exports = (app) => {
  ...
  app.post(base + "periksa", [authJwt.verifyToken], controller.periksa);
  ...
  */
  ...
  app.get(
    base + "pemeriksaan/:uuid",
    [authJwt.verifyToken],
    controller.findAllPemeriksaan
  );
  app.get(
    base + "produsen/:uuid",
    [authJwt.verifyToken],
  ...
  app.get(base + "unduhQA/:uuid", controller.downloadQA);
