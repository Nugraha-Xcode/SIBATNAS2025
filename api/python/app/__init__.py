...
from .main.controller.activities_controller import api as activities_ns
...
from .main.controller.provinces_controller import api as provinces_ns
from .main.controller.csw_controller import api as csw_ns

# Import apidoc for monkey patching
from flask_restplus.apidoc import apidoc

URL_PREFIX = '/sikambing/api'
...
def specs_url(self):
    ...
    return URL_PREFIX + '/swagger.json'
...
api.add_namespace(provinces_ns)
